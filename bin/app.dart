...
// Using a List of Maps to store the JSON data
const List<Map<String, dynamic>> jsonData = [
  {
...
void main() {
  UserManager userManager = UserManager.fromJson(json.encode(jsonData));

  print('All Users:');
  print(userManager.getAllUsers());

  print('\n User with first name "Keisha":');
  print(userManager.getUserByFirstName("Keisha"));

  print('\n User with email "larsonmcfarland@rocklogic.com":');
  print(userManager.getUserByEmail("larsonmcfarland@rocklogic.com"));

  print('\n Children of user with first name "Alexis":');
  print(userManager.getChildrenByFirstName("Alexis"));
}
